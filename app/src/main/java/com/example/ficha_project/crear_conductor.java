...
public class crear_conductor extends AppCompatActivity {
    ...
    public void registrarse(View v){
        ...
        if (paquete!=null){
            ...
            crearConductor(nombre, apellido, correo, contrasena, telefono, foto);
        }
    }

    private void crearConductor(final String nombre, final String apellido, final String correo, final String contrasena, final String telefono, final String foto) {
        StringRequest stringRequest = new StringRequest(
                Request.Method.POST,
                URL,
                response -> Toast.makeText(crear_conductor.this, "Registro exitoso", Toast.LENGTH_SHORT).show(),
